...
local BNOChengUserName = database:get(bot_id.."BNO:Cheng:UserName"..data.id_)
if not data.username_ then 
if BNOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BNOChengUserName..']')
database:del(bot_id.."BNO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BNOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BNO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
